...
# Task 2: count number of '0' after receiving first '2' in sequence
def assign_weight_count_task2(cell, in_dim, out_dim):
    param_dict = {}
...
# Task 3
def assign_weight_count_task3(cell, in_dim, out_dim):
    param_dict = {}
